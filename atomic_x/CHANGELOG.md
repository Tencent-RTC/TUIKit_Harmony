...
- Seamless integration with atomicxcore SDK
...
- atomicxcore SDK integration for messaging components
...
This is the first stable release of Atomic_X for HarmonyOS, providing a complete unified component library with the
